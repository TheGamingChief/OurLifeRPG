class TGC_CopMenu
{
	...
	class controls
	{
		...
		class TGC_Button_1: RscButtonV2
		{
			...
			w = 0.0889128 * safezoneW;
			h = 0.0287371 * safezoneH;
			action = "[] call OL_fnc_Handcuff; closedialog 0;";
		};
		...
		class TGC_Button_6: RscButtonV2
		{
			...
			w = 0.0889128 * safezoneW;
			h = 0.0287371 * safezoneH;
			action = "[] call OL_fnc_Gag; closedialog 0;";
		};
		class TGC_Button_7: RscButtonV2
		{
			...
			w = 0.0889128 * safezoneW;
			h = 0.0287371 * safezoneH;
			action = "[] call OL_misc_ForceFeed; closedialog 0;";
		};
		...
		class TGC_Button_9: RscButtonV2
		{
			...
			w = 0.0889128 * safezoneW;
			h = 0.0287371 * safezoneH;
			action = "closedialog 0;[] call OL_ui_ArrestMenu;";
		};
	};
};
...
class TGC_ArrestMenu
{
	...
	class controls
	{
		...
		{
			idc = 1900;
			onSliderPosChanged = "ctrlSetText [65478, format[localize ""STRS_dialogcivmenu_arrest"", str round(sliderPosition 1900)]];";
