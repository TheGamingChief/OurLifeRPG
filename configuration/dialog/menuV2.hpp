class adminMenuTCG
{
	...
	class button8: RscButton
	{
		idc = 1600;
		text = "Become Kewl";
		action = "[""FOX_US_SFMRW_OFFD""] spawn OL_fnc_Clothes;  [""olrpg_cpbell206"", player] call inv_createvehicle;";
		x = 0.71;
		y = 0.609991 ;
		w = 0.278526;
		h = 0.0329973 ;
	...
	class button9: RscButton
	{
		idc = 1601;
		text = "Revive Player";
		action = "(adminMenu_Players select (lbCurSel 1500)) setVariable ['KOED', false, true]; (adminMenu_Players select (lbCurSel 1500)) setVariable ['R3F_REV_est_inconscient', false, true];";
		x = 0.71;
		y = 0.653987 ;
		w = 0.278526;
		h = 0.0329973 ;
