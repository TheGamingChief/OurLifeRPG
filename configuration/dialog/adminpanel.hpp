...
class AdminPanel_Default
{
	...
	class adminconsol_activate:RscButton
	{
		...
		action="[player] call OL_Admin_Items_Admin;";
		x=0.4;
		y=0.746666666666667;
		w=0.222222222222222;
...
class AdminPanel_Swag
{
	name=AdminPanel_Swag;
	idd=-1;
	movingEnable=1;
	controlsBackground[]={adminconsol_background};
	objects[]={};
	...
	class adminconsol_activate:RscButton
	{
		idc=-1;
		text="Activate Command";
		action="[player] call OL_Admin_Items_Swag;";
		x=0.4;
		y=0.746666666666667;
		w=0.222222222222222;
		h=0.0711111111111111;
	...
	class adminconsol_frame:RscBgFrameDev
	{
		idc=-1;
		x=0.288888888888889;
		y=0.106666666666667;
