...
//--------------------------------------BUY-----------------------------------------
_CopOnlyShops = [copuntrained,copbasic1,copbasic2,copbasic3,copbasic4,copbasic5,copbasic6,coptraffic1,coptraffic2,coptraffic3,coptraffic4,coptraffic5,coptraffic6,coppo1,coppo2,coppo3,copcpl,copsgt,ftobox,copdispatch,copdeputy,copsheriff,copsheriffdnr,coplt,copcpt,copchief,coptrafficdivision,copair,copair2,copswat1,copswat2,copswat3,copswat4,copswat5,copswate,copswatd,copswatvehicle,copcoastguard,copcoastguard2,copcoastguardair,copairweapon,copairweapon2,copVIPBox,copVIPBox2];
...
_copfto = [ftobox];
_Deputy = [copdeputy,copsgtdeputy,copsheriffdnr];
_Sheriff = [copsheriff];
_Lt = [coplt];
_Cpt = [copcpt];
_Chief = [copchief];
...
_CoastGuard = [copcoastguard,copcoastguard2,copcoastguardair];
...
/*  Not In The Server ATM, Pointless shit
