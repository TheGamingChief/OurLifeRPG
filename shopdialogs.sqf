...
//--------------------------------------BUY-----------------------------------------
_CopOnlyShops = [copuntrained,copbasic1,copbasic2,copbasic4,copbasic6,coppo1,coppo2,coppo3,copcpl,copsgt,ftobox,cidbox,copdeputy,copsheriff,copsheriffdnr,coplt,copcpt,copchief,copair2,copswat1,copswat2,copswat3,copswat4,copswat5,copswat6,copswate,copswatd,copswatvehicle,copcoastguard,copcoastguard2,copcoastguard3,copcoastguardair,copairweapon2,copVIPBox,copVIPBox2,copk92,corbox,corsbox,corcbox,copsgtdeputy];
...
_SWAT = [copswat1,copswat2,copswat3,copswat4,copswat5,copswat6,copswatvehicle];
_CID = [cidbox];
_COR = [corbox,corsbox,corcbox],
_CoastGuard = [copcoastguard,copcoastguard2,copcoastguard3,copcoastguardair];
...
if(_shop in _donor6 and !((getPlayerUID player) in Donate_id6)) exitwith {player groupchat "You're not a donator!"; closedialog 0};
...
if(_shop in _EMT1 and !((getPlayerUID player) in EMT1_id)) exitwith {player groupchat "You're not a EMT 1"; closedialog 0};
if(_shop in _EMT2 and !((getPlayerUID player) in EMT2_id)) exitwith {player groupchat "You're not a EMT 2"; closedialog 0};
...
if(_shop in _EMT_Command and !((getPlayerUID player) in ESUCommand_id)) exitwith {player groupchat "You're not a EMS Command"; closedialog 0};
