...
bankflagarray            = [mainbank,copbank,copairbank,copairbank2,copswatbank,copsgtbank,copdispatchbank,copsheriffbank,copcmdbank,copcoastguardbank,atm1,atm2,atm3,atm4,atm5,atm6,atm7,atm8,atm10,atm11,atm12,atm13,atm14,donoratm,milpbank,ciabank,IRAatm,bhuntbank,atmswag,devatm,atmmall,atmsubfire,pmcbank];
speedcamarray            = [speed1,speed2,speed3,speed4,speed5,speed6];
