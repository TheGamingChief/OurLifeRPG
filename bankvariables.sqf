...
bankflagarray            = [mainbank,copbank,copairbank,copswatbank,copsgtbank,cidbank,copdispatchbank,copsheriffbank,copcmdbank,copcoastguardbank,atm1,atm5,atm6,atm10,atm11,atm12,atm13,IRAatm,atmswag,devatm,atmmall,atmsubfire,pmcbank,atmjail,towatm];
