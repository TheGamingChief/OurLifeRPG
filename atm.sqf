...
CtrlSetText [101, format [localize "STRS_bank_dialog_inventargeld", (_geld call OL_ISSE_str_IntToStr)]];
CtrlSetText [102, format [localize "STRS_bank_dialoge_accountgeld",  (Kontostand call OL_ISSE_str_IntToStr)]];
...
if (lbCurSel 1 == (_liste select 1)) then 
	...
	CtrlSetText [5, format ["$%1", ((round((_slider*100)/(100-bank_steuer))) call OL_ISSE_str_IntToStr)]];
