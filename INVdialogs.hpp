...
class inventar{
	...
	objects[] = { };	
	controls[] = {header, button_use, button_save, button_drop, button_cancel, TransferButton,InfoItem, InfoItemVar, InfoAnzahl, InfoAnzahlVar, InfoAddinfo, InfoAddinfoVar, InfoGewicht, InfoGewichtVar,UseAmounteingabe,description, playerlist, Itemlist, dummybutton};		
	...
	w = 0.20; h = 0.04;			
	text = "SAVE ACCOUNT";
	action = "call RL_FNC_ACCOUNT_SAVE";	
	};								
