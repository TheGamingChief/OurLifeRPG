...
if (_itemart == "item") then
	...
	["Sell_Log", format ["%1 (%2) has sold %3 %4 at %5 for $%6", name player, getPlayerUID player, _menge, _infos call INV_getitemName, _gridPos, _cost]] call RM_fnc_LogToServer;
	};
...
if (_itemart == "waffe") then
	...
	["Sell_Log", format ["%1 (%2) has sold %3 at %4 for $%5", name player, getPlayerUID player, _infos call INV_getitemName, _gridPos, _CostMitTax]] call RM_fnc_LogToServer;
	};
...
if(_itemart == "fahrzeug")then
{
	...
	["Sell_Log", format ["%1 (%2) has sold %3 at %4 for $%5", name player, getPlayerUID player, _vehicle, _gridPos, _CostMitTax]] call RM_fnc_LogToServer;
