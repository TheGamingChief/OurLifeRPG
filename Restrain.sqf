...
format['%1 setVariable ["tf_unable_to_use_radio", false]', _civ] call broadcast;
format['server globalChat "%2 was released by %1";',name player, name _civ] call broadcast;
...
[_civ,"restrain"] call fn_netSay3D;
format['%1 setVariable ["tf_unable_to_use_radio", true]', _civ] call broadcast;
(format['server globalchat "%3 was handcuffed by %2";if (rolestring == "%1") then {execVM "Unrestrain.sqf";}', _civ, name player, name _civ]) call broadcast;
