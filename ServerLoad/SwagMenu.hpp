class SwagLife_MenuT
{
      idd = -1;
	  Movingenable = true;
	  controlsBackground[] = {RscPicture_1200};
	  controls[] = {RscPicture_1200,RscPicture_1201,RscPicture_1202,RscPicture_1203,RscPicture_1204,RscPicture_1205,RscPicture_1206,RscPicture_1207,RscPicture_1208,RscPicture_1209,RscPicture_1210,RscPicture_1211,RscButton_1600,RscButton_1601,RscButton_1602,RscButton_1603,RscButton_1604,RscButton_1605,RscButton_1606,RscButton_1607,RscButton_1608,RscButton_1609,RscButton_1610};
...
class RscPicture_1200: RscPicture
{
	...
	style = ST_PICTURE;
	idc = 1200;
	text = "ol_textures\images\DIALOG.PAA";
...
{
	idc = 1201;
	text = "ol_textures\images\PHONE.PAA";
...
{
	idc = 1202;
	text = "ol_textures\images\SETTINGS.PAA";
...
{
	idc = 1203;
	text = "ol_textures\images\WARRANTS.PAA";
...
{
	idc = 1204;
	text = "ol_textures\images\SPAWN LOCATION.PAA";
...
{
	idc = 1205;
	text = "ol_textures\images\SAVE.PAA";
...
{
	idc = 1206;
	text = "ol_textures\images\MESSAGES.PAA";
	x = 0.368352 * safezoneW + safezoneX;
...
{
	idc = 1207;
	text = "ol_textures\images\LICENSES.PAA";
	x = 0.450724 * safezoneW + safezoneX;
	y = 0.571631 * safezoneH + safezoneY;
	w = 0.0510157 * safezoneW;
	h = 0.0687132 * safezoneH;
...
{
	idc = 1208;
	text = "ol_textures\images\LAWS.PAA";
...
{
	idc = 1209;
	text = "ol_textures\images\GANGS.PAA";
...
{
	idc = 1210;
	text = "ol_textures\images\BANK.PAA";
...
{
	idc = 1211;
	text = "ol_textures\images\STAFF SETTINGS.PAA";
	x = 0.368352 * safezoneW + safezoneX;
...
{
    action = "createDialog 'Swag_SpawnMenu';";
...
{
    action = "[0,0,0,[""licensecheck""]] execVM 'maindialogs.sqf';";
...
{
    action = "[0,0,0,[""spielerliste""]] execVM 'maindialogs.sqf';";
...
{
    action = "[] execVM 'atm.sqf';createdialog ""bank""";
