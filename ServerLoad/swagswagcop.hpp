class Swagswag_lifecop
{
	  ...
	  name = "Swagswag_lifecop";
	  onLoad = "with uiNameSpace do {Swagswag_lifecop = _this select 0}";
...
class RscPicture_1200: RscPicture
{
	...
	style = ST_PICTURE;
	idc = 1200;
	text = "ol_textures\images\DIALOGPD.PAA";
...
{
	idc = 1204;
	text = "ol_textures\images\CIVILIAN.PAA";
...
{
	idc = 1207;
	text = "ol_textures\images\DMV.PAA";
	x = 0.450724 * safezoneW + safezoneX;
	y = 0.571631 * safezoneH + safezoneY;
	w = 0.0510157 * safezoneW;
	h = 0.0687132 * safezoneH;
...
{
	idc = 1209;
	text = "ol_textures\images\Computer.PAA";
...
{
    action = "[] execvm 'deaddem2\STATSAVE\dd_SaveStats.sqf';";
...
{
    action = "if(vehicle player != player)then{[""mds_open_home""] execVm ""deaddem\mds\mds_func.sqf""};";
