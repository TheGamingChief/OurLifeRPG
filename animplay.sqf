...
_animname       = ((OL_AllAnimationsArray select _animnumber) select 0);
_animart        = ((OL_AllAnimationsArray select _animnumber) select 2);
_withWeapon     = ((OL_AllAnimationsArray select _animnumber) select 4);
_callScript     = ((OL_AllAnimationsArray select _animnumber) select 5);
_hasweapon  		= false;
