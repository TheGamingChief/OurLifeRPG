...
if (_art == "holen") exitWith  {
	...
	while {true} do {
		...
		for [{_i=0}, {_i < 120}, {_i=_i+1}] do {
			...
			if ((player distance _hurenname <= 5) and ((player distance getMarkerPos "Delivery5_1_3" < 15) or (player distance getMarkerPos  "Delivery5_1_1_1" < 15) or (player distance getMarkerPos "Delivery5_1_2_1" < 15))) then {
