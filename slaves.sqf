...
['geld', -(slave_cost)] call INV_AddInvItem;

player groupChat format[localize "STRS_slave_gekauft", rolestring, (slave_cost call OL_ISSE_str_IntToStr)];
...
if (_arbeitergeld > 0) then
	...
	call compile format ["arbeitergeld%1 = 0;", _arbeiternummer];
	player groupChat format [localize "STRS_slave_geldabnahme_ja", (_arbeitergeld call OL_ISSE_str_IntToStr)];
