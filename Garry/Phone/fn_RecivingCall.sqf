...
if (OL_inCall) exitWith { [["IN_CALL"], "Phone_fnc_CallFailed", _this select 0, false, true] call OL_Network_MP };
if (OL_RecivingCall) exitWith { [["RECIVING_CALL"], "Phone_fnc_CallFailed", _this select 0, false, true] call OL_Network_MP };
