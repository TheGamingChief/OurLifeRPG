...
if (isnil "mapm") then 
{
	...
	[format["[ADMIN_PANNEL_LOG] Admin %1 has Toggled Tags ON", name player]] call fn_LogToServer;
...
else 
{
	...
	[format["[ADMIN_PANNEL_LOG] Admin %1 has Toggled Tags OFF", name player]] call fn_LogToServer;
};
