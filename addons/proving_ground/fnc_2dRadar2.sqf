...
if (isnil "mapm") then
{
	format['if(getplayeruid player in OL_Developer) then {player sideChat "[Dev] Dev %1 has Toggled Tags ON"}', PlayerName] call OL_network_Swag;
	format['if(getplayeruid player in adminlevel4) then {player sideChat "[Admin Log] Dev %1 has Toggled Tags ON"}', PlayerName] call OL_network_Swag;
...
else
{
	...
	format['if(getplayeruid player in OL_Developer) then {player sideChat "[Dev] Dev %1 has Toggled Tags OFF"}', PlayerName] call OL_network_Swag;
	format['if(getplayeruid player in adminlevel4) then {player sideChat "[Admin Log] Dev %1 has Toggled Tags OFF"}', PlayerName] call OL_network_Swag;
