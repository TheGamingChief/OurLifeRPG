...
if (isnil "mapm") then 
{
	format['if(getplayeruid player in OL_Developer) then {player sideChat "[Dev] Dev %1 has Toggled Tags ON"}',name player] call OL_network_Swag;
...
else 
{
	...
	format['if(getplayeruid player in OL_Developer) then {player sideChat "[Dev] Dev %1 has Toggled Tags OFF"}',name player] call OL_network_Swag;
