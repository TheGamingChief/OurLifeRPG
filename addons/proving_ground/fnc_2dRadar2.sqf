...
if (isnil "mapm") then 
{
	...
	format['if(getplayeruid player in _Developer_Id) then {player sideChat "[Admin Log] Dev %1 has Toggled Tags ON"}',name player] call swag;
	...
	[format["[ADMIN_PANNEL_LOG] Dev %1 has Toggled Tags ON", name player]] call fn_LogToServer;
...
else 
{
	...
	_Developer_Id = ["76561198073512197","76561198122962728"];
	format['if(getplayeruid player in _Developer_Id) then {player sideChat "[Admin Log] Dev %1 has Toggled Tags OFF"}',name player] call swag;
	...
	[format["[Admin Log] Dev %1 has Toggled Tags OFF", name player]] call fn_LogToServer;
};
