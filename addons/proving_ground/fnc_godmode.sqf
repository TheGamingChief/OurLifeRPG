...
igodokxtt=1;
hint "GOD mode ON";
//format['server globalChat "(ADMIN)%1 Has Just Turned On God Mode";', name player] call swag;
sleep 0.001;
}
else
{
...
//format['server globalChat "(ADMIN)%1 Has Just Turned Off God Mode";', name player] call swag;
sleep 0.001;
};
