...
//background
	class balca_loader_background_veh
	{
		...
		type = CT_STATIC;
		style = ST_PICTURE;
		x = PGsafezoneX; w = display_weight;
		y = PGsafezoneY; h = display_height/2;
		colorText[] = {1, 1, 1, 1};
...
//controls
	...
	{
		x = PGsafezoneX + border_offsetX + column_weight; 
		w = column_weight - border_offsetX;
		y = PGsafezoneY + border_offsetY; 
		h = str_height;
		colorText[] = {1, 1, 1, 1};
		colorBackground[] = {0,0,0,0};
		text = "Vehicles";
	...
	{
		x = PGsafezoneX + border_offsetX + column_weight*2; 
		w = column_weight - border_offsetX;
		y = PGsafezoneY + border_offsetY; 
		h = str_height;
		colorText[] = {1, 1, 1, 1};
	...
	{
		x = PGsafezoneX + border_offsetX + column_weight*3; 
		w = column_weight - border_offsetX;
		y = PGsafezoneY + border_offsetY; 
		h = str_height;
		colorText[] = {1, 1, 1, 1};
	...
	{
		x = PGsafezoneX + border_offsetX + column_weight*1; 
		w = column_weight - border_offsetX;
		y = display_height/2 + border_offsetY*2; 
		h = str_height;
		colorText[] = {1, 1, 1, 1};
	...
	class balca_loader_ammo_info : balca_loader_text
	{
		...
		h = display_height/2 - offset_bottom - (PGsafezoneY + border_offsetY + offset_top);
		colorText[] = {1, 1, 1, 1};
		colorBackground[] = {0,0,0,0};
		text = "";
	};
////////
	class balca_loader_vehicle_shortcut : balca_loader_image
	{
		...
		x = PGsafezoneX + border_offsetX; 
		w = column_weight - border_offsetX;
		y = PGsafezoneY + border_offsetY + offset_top; 
		h = img_height;
		colorText[] = {1, 1, 1, 1};
		colorBackground[] = {0,0,0,0};
...
////////
	class balca_loader_restore_btn : balca_loader_btn
	{
		...
		x = PGsafezoneX + border_offsetX; w = 0.16;
	...
	class balca_loader_load_btn : balca_loader_btn
	{
		...
		x = PGsafezoneX + border_offsetX + column_weight*1; w = 0.16;
		y = display_height - 0.16;
		text = "Load";
	...
	class balca_loader_unload_btn : balca_loader_btn
	{
		...
		x = PGsafezoneX + border_offsetX + column_weight*2; w = 0.16;
		y = display_height - 0.16;
		text = "Unload";
	...
	{
		x = PGsafezoneX + border_offsetX + column_weight*3; w = 0.16;
		y = display_height - 0.16;
		text = "Close";
