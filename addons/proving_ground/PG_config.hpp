	...
	class balca_btn_control_group : balca_debug_control_group {
		...
		//column 1
			...
			class usbw_button : balca_debug_btn
			{
				...
				y = btn_height*5;
				text = "Admin Message";
				action = "closeDialog 0;createDialog ""MSG"";";
			};

			class usbw_button1 : balca_debug_btn
			{
				x = 0; w = column_weight-column_div;
				y = btn_height*6;
				text = "Get Bank Code";
		...
		//column 3
			...
			class balca_console_btn : balca_debug_btn
			{
				...
				y = btn_height*4;
				text = "Console";
				action = "if (getPlayerUID player == PGConsole_Blacklist) exitWith {};closeDialog 0;createDialog ""balca_debug_console"";[0] call c_proving_ground_fnc_exec_console;";
			};
...
/////////////////
	class balca_debug_background
	{
		...
		type = CT_STATIC;
		style = ST_PICTURE;
		x = PGsafezoneX-border_offsetX; w = column_weight*3 + border_offsetX*3;
		y = PGsafezoneY-border_offsetY-btn_height*3; h = display_height+border_offsetY*2+btn_height*4;
		colorText[] = {1, 1, 1, 1};
...
/////////////////
	class balca_debug_background
	{
		...
		type = CT_STATIC;
		style = ST_PICTURE;
		x = PGsafezoneX-border_offsetX; w = column_weight*3 + border_offsetX*4;
		y = PGsafezoneY-border_offsetY; h = display_height+border_offsetY*2;
		colorText[] = {1, 1, 1, 1};
		colorBackground[] = {0,0,0,0};
		text = "\ca\ui\data\ui_gameoptions_background_ca.paa";
		font = "Zeppelin32";
...
/////////////
	...
	class balca_debug_console_edit : balca_debug_edit
	{
		...
		x = PGsafezoneX; w = column_weight*3;
		y = PGsafezoneY + offset_top*2; h = str_height*3;
...
/////////////////
	class balca_debug_background
	{
		...
		style = ST_PICTURE;
		x = PGsafezoneX-border_offsetX; w = column_weight*3 + border_offsetX*3;
		y = PGsafezoneY-border_offsetY; h = display_height+border_offsetY*2+btn_height*1;
		colorText[] = {1, 1, 1, 1};
		colorBackground[] = {0,0,0,0};
		text = "\ca\ui\data\ui_gameoptions_background_ca.paa";
		font = "Zeppelin32";
...
/////////////////
	class balca_debug_background
	{
		...
		type = CT_STATIC;
		style = ST_PICTURE;
		x = PGsafezoneX-border_offsetX; w = column_weight*1 + border_offsetX*3;
		y = PGsafezoneY-border_offsetY; h = display_height+border_offsetY*2+btn_height*1;
		colorText[] = {1, 1, 1, 1};
		colorBackground[] = {0,0,0,0};
		text = "\ca\ui\data\ui_gameoptions_background_ca.paa";
