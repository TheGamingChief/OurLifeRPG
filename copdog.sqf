...
//createGroup (side player);
		...
		[
			...
			["", [], "", -1, [], "0", "0"],
			["Attack Target", [5], "", -5, [["expression", "nul = [cursorTarget] spawn OL_misc_dogAttack"]], "1", "1", "\ca\ui\data\cursor_attack_ca.paa"],
			["Drug Search", [6], "", -5, [["expression", "nul = [cursorTarget] spawn OL_misc_dogSearch"]], "1", "1", "\ca\ui\data\cursor_attack_ca.paa"],
			["Drug Search", [6], "", -5, [["expression", "nul = [cursorTarget] execVM 'dogSearch.sqf'"]], "1", "1", "\ca\ui\data\cursor_igui_scroll_ca.paa"],
			["", [], "", -1, [], "0", "0"],
			["Board Car", [8], "", -5, [["expression", "nul = [1, cursorTarget] spawn OL_misc_dogVehicle"]], "1", "CursorOnEmptyVehicle", "\ca\ui\data\cursor_getin_ca.paa"],
			["Dismount", [9], "", -5, [["expression", "nul = [2] spawn OL_misc_dogVehicle"]], "1", "0", "\ca\ui\data\icon_board_out_ca.paa"],
