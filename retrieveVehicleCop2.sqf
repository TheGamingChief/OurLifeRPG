	...
	_v = format ["vehicle_%1_%2",player,round(time)];
		...
		if ((vehicle2spawn in _crowns) or (vehicle2spawn in _sheriff220) or (vehicle2spawn in _sherifsub) or (vehicle2spawn in _genovahsCar) or (vehicle2spawn in _tahoesherif) or (vehicle2spawn in _crownsherif) or (vehicle2spawn in _tahoe) or (vehicle2spawn in _k9) or (vehicle2spawn in _traffic))  then 
		{
		 if(vehicle2spawn in _sherifsub) then {
				...
				this setObjectTexture [0, ""ol_textures\text\sheriff.paa""];this setObjectTexture [45,""ol_textures\text\sheriff.paa""];this setObjectTexture [46,""ol_textures\text\sheriff.paa""];this setObjectTexture [47,""ol_textures\text\sheriff.paa""];this setObjectTexture [48,""ol_textures\text\sheriff.paa""];
		 ...
		 if(vehicle2spawn in _sheriff220) then {
				...
				newvehicle = vehicle2spawn createVehicle %4; 
				newvehicle setVehicleInit "
				this setObjectTexture [0, ""ol_textures\text\F220.paa""];this setObjectTexture [45,""ol_textures\text\F220.paa""];this setObjectTexture [46,""ol_textures\text\F220.paa""];this setObjectTexture [47,""ol_textures\text\F220.paa""];this setObjectTexture [48,""ol_textures\text\F220.paa""];
				this setVehicleVarName ""vehicle_%1_%2""; 
				vehicle_%1_%2 = this; 
				clearWeaponCargo this; 
				clearMagazineCargo this;
		 ...
		 if(vehicle2spawn in _crownsherif) then {
				...
				newvehicle = vehicle2spawn createVehicle %4; 
				newvehicle setVehicleInit "
				this setObjectTexture [0, ""ol_textures\text\f106.paa""];this setObjectTexture [45,""ol_textures\text\f106.paa""];this setObjectTexture [46,""ol_textures\text\f106.paa""];this setObjectTexture [47,""ol_textures\text\f106.paa""];this setObjectTexture [48,""ol_textures\text\f106.paa""];
				this setVehicleVarName ""vehicle_%1_%2""; 
				vehicle_%1_%2 = this; 
				clearWeaponCargo this; 
				clearMagazineCargo this;
