...
switch (adminCMD) do
{
	...
	case 2: //Delete
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has Deleted %2",name player, cursorTarget]] call fn_LogToServer;
	};
	case 3: //Spectate
	{
	...
	case 5: //Teleport
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has Ran Teleport!",name player]] call fn_LogToServer;
	};
	case 6: //Donuts
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has Spawned Donuts",name player]] call fn_LogToServer;
	};
	case 7: //Heal
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has 3M Healed!",name player]] call fn_LogToServer;
	};
	case 8: //Teleport2Me
	{
	...
	case 10: //10M Clean
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has started a 10M Cleanup",name player]] call fn_LogToServer;
	};
	case 11: //Restart Announcement
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has started the restart announcement",name player]] call fn_LogToServer;
	};
	case 12: //GPS,NV,Binoc
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has Spawned GPS,NV,Binoc",name player]] call fn_LogToServer;
	};
	...
	case 13: //PG Spawn
	{
		...
		[format["[ADMIN_PANNEL_LOG] Senior Admin %1 has Opened PGSpawn",name player]] call fn_LogToServer;
	};
	...
	case 14: //World Heal
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has done a World Heal",name player]] call fn_LogToServer;
	};
	case 15: //Server Cleaner 
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has executed server cleaner",name player]] call fn_LogToServer;
	};
	case 16: //Global Comp 100k 
	{
		...
		[format["[ADMIN_PANNEL_LOG] Admin %1 has Global Comped for 100k",name player]] call fn_LogToServer;
