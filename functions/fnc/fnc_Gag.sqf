...
if (civmenuciv getVariable "Gagged") exitWith {
  ...
  ["Gag_Log", format ["%1 (%2) was ungagged by %3 (%4)", name civmenuciv, getPlayerUID civmenuciv, player getVariable "RealName", getPlayerUID player]] call RM_fnc_LogToServer;
};
...
', civmenuciv, player getVariable "RealName"] call OL_network_Swag;

player groupChat "You gagged the player";
["Gag_Log", format ["%1 (%2) was Gagged by %3 (%4)", name civmenuciv, getPlayerUID civmenuciv, player getVariable "RealName", getPlayerUID player]] call RM_fnc_LogToServer;
