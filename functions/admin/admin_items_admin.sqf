...
switch (adminCMD) do
{
	...
	case 2: //Delete
	{
		...
		closeDialog 0;
		hint "OBJECT DELETED";
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has Deleted %2"}',name player, cursorTarget] call OL_network_Swag;
	...
	case 6: //Teleport
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has Ran Teleport!"}',name player] call OL_network_Swag;
	...
	case 7: //Donuts
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has Spawned Donuts"}',name player] call OL_network_Swag;
	...
	case 8: //Heal
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has 3M Healed!"}',name player] call OL_network_Swag;
	...
	case 10: //10M Clean
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has started a 10M Cleanup"}',name player] call OL_network_Swag;
	...
	case 11: //GPS,NV,Binoc
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has Spawned GPS,NV,Binoc"}',name player] call OL_network_Swag;
	...
	case 12: //PG Spawn
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Senior Admin %1 has Opened PGSpawn"}',name player] call OL_network_Swag;
	...
	case 13: //World Heal
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has done a World Heal"}',name player] call OL_network_Swag;
	...
	case 14: //Server Cleaner
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has executed server cleaner"}',name player] call OL_network_Swag;
	...
	case 15: //Global Comp 100k
	{
		...
		format['if(getplayeruid player in Developer_id) then {player sideChat "[Admin Log] Admin %1 has Global Comped for 100k"}',name player] call OL_network_Swag;
