...
if ((_vcl isKindOf _type call INV_getitemTypeKg > 2) || (_vcl isKindOf "Motorcycle") || (_vcl isKindOf "Ship") || (typeOf _vcl in _blackList)) exitwith { player groupchat "You cannot tune this vehicle" };
