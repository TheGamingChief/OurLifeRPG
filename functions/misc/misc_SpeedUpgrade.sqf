...
_vcl			 = vehicle player;
_type			 = typeof _vcl;
_blacklist = ["schoolbus", "jailbus", "Ikarus_TK_CIV_EP1", "Ikarus", "MMT_USMC", "MMT_Civ", "cl_wheelchair", "laddertruck", "rescue", "a2l_kme_res", "a2l_kme", "laddertruck2", "engine", "a2l_kme_res116"];
